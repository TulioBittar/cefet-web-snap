...
const marcacaoOculta = document.querySelector('#visibilidade-das-marcacoes');

marcacaoOculta.addEventListener('input', () => {
    ancestral.classList.toggle(marcacaoOculta.value, marcacaoOculta.checked);
})
